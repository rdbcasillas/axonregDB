    ...
    <b-container>
      ...
      <b-row>
        ...
        <b-col class="download" cols="3" v-if="flag">
          <a v-if="$route.name== 'expression'"  href="https://129.114.104.79.xip.io/website-data/dev_fpkm.tsv" class="btn btn-primary" download>Download Raw Data</a>
          ...
          <a v-if="$route.name== 'histone'"  href="https://129.114.104.79.xip.io/website-data/histone-prom-fc.zip" class="btn btn-primary" download>Download Raw Data</a>
        </b-col>
    ...
    async fetchData() {
      ...
      if (this.$route.name == "expression") {
        ...
        this.geneData4  = await d3.tsv(
          "https://129.114.104.79.xip.io/website-data/dev-series-tsv/E11toP0_h3k27me3_prom.fc.tsv"
        );
        this.geneData5  = await d3.tsv(
          "https://129.114.104.79.xip.io/website-data/dev-series-tsv/E12toP0_h3k9ac_prom.fc.tsv"
        );
        this.allgenes = _.map(this.geneData, "external_gene_name");
        this.ylabel = "Feature Count";
